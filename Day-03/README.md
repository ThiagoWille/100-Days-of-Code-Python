...
Neste dia, o foco foi sair da programação linear para criar sistemas que reagem a diferentes entradas do usuário através de caminhos lógicos.

- Projeto de Destaque: 🏝️ Treasure Island (Ilha do Tesouro)

  - Um jogo de aventura textual que utiliza condicionais aninhadas para criar múltiplos finais baseados nas escolhas do jogador.

- Conceitos Técnicos Praticados:

  - Estruturas Condicionais: Implementação de if, else e múltiplos elif para lidar com diversas rotas de decisão.
